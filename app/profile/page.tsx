...
type Profile = {
  ...
  fav_race_stage_num: number | null
}
type RaceLog = {
  id: string
  slug: string
      ...
      <div className="profile-layout">
        ...
        <div className="profile-sidebar">
          ...
          <div style={{ marginTop: 8 }}>
            <button className="bs" style={{ width: '100%', fontSize: 9, padding: 8 }} onClick={() => setEditProfileOpen(true)}>
              ✏ Edit Profile
            </button>
          </div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
              {sortedCountries.map(([country, cnt]) => (
                <Link
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: 6, background: 'var(--card-bg)', border: '1px solid var(--border)', padding: '5px 10px', fontSize: 11, letterSpacing: 1, textDecoration: 'none', cursor: 'pointer', transition: 'border-color .15s' }}
