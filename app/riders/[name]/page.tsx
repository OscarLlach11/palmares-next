...
export default function RiderPage() {
  ...
  async function load() {
    ...
    if (!slRows?.length) {
      ...
      setInfo({ rider_name: best.rider_name, team_name: best.team_name, nationality: best.nationality, image_url: best.image_url && best.image_url !== 'none' ? best.image_url : null })
    } else {
